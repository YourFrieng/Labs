...
public:
	...
	friend std::ostream& operator<<(std::ostream& s, const Arr& A);
	friend std::istream& operator>>(std::istream& s, Arr& A);
	void print();
	int getSize();
...
std::ostream& operator<<(std::ostream& s, const Arr& A)
{
	s << "[ ";
...
std::istream& operator>>(std::istream& s, Arr& A)
{
